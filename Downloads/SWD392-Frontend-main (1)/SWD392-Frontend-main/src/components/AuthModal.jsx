                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-red-500 transition-colors appearance-none bg-white cursor-pointer"
                      required={!isLogin}
                    >
